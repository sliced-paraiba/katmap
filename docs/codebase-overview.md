...
│   ├── bin/export_types.rs # Generator for checked-in TypeScript wire types
...
│   ├── types.ts         # Re-exports generated wire types plus client-only history types
│   ├── generated/types.ts # Generated TypeScript wire types from server/src/types.rs
...
| `types.rs` | Serde/ts-rs-annotated enums for `ClientMessage`, `ServerMessage`, and supporting structs (`Waypoint`, `RouteLeg`, `Maneuver`, `BreadcrumbPoint`) |
...
| `types.ts` | Re-exports generated wire types from `generated/types.ts` and keeps client-only `HistoryEntry` aliases |
| `generated/types.ts` | Checked-in TypeScript wire declarations generated by `cargo run --manifest-path server/Cargo.toml --bin export-types` |
